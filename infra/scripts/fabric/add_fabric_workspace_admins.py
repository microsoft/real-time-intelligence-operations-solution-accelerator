#!/usr/bin/env python3
"""
Add administrators to all available Microsoft Fabric workspaces.

This script adds specified administrators to all Microsoft Fabric workspaces that the current user has access to.
...
Usage:
    python add_fabric_workspace_admins.py --fabricAdmins user@contoso.com admin@company.com
    python add_fabric_workspace_admins.py --fabricAdminsByObjectId 12345678-1234-1234-1234-123456789012
    python add_fabric_workspace_admins.py --fabricAdmins user@contoso.com --fabricAdminsByObjectId 12345678-1234-1234-1234-123456789012

Prerequisites:
    - Azure CLI (logged in): az login
    - Python packages: requests, azure-identity, azure-storage-file-datalake
...
def process_workspace_admins(fabric_client, workspace, fabric_admins, fabric_admins_by_object_id, graph_client, global_stats):
    ...
    if fabric_admins:
        ...
        for admin_identifier in fabric_admins:
            result = add_workspace_admin(fabric_client, workspace_id, admin_identifier, existing_admin_principals, graph_client)
    ...
    if fabric_admins_by_object_id:
        ...
        for object_id in fabric_admins_by_object_id:
            result = add_workspace_admin_by_object_id(fabric_client, workspace_id, object_id, existing_admin_principals)
