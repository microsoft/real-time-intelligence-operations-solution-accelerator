...
Requirements:
    ...
    - azure-mgmt-eventhub package: pip install --index-url https://packagefeedproxy.microsoft.io/pypi/simple/ azure-mgmt-eventhub

Environment Setup:
    pip install --index-url https://packagefeedproxy.microsoft.io/pypi/simple/ azure-mgmt-eventhub azure-identity
"""
